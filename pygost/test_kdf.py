    ...
    def runTest(self):
        self.assertEqual(
            kdf_gostr3411_2012_256(
                ...
                bytes.fromhex("26bdb878"),
                bytes.fromhex("af21434145656378"),
            ),
...
class TestKDFTREEGOSTR34112012256(TestCase):
    def runTest(self):
        ...
        self.assertSequenceEqual(
            ...
            (
                bytes.fromhex("22b6837845c6bef65ea71672b265831086d3c76aebe6dae91cad51d83f79d16b"),
                bytes.fromhex("074c9330599d7f8d712fca54392f4ddde93751206b3584c8f43f9e6dc51531f9"),
            ),
        )
